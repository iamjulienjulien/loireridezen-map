...
export const CARNETS_REGISTRY = [
    {
        ...
        accroche:
            'Étapes, gîtes, ravitaillement, ombrages. Le carnet du voyageur cycliste, pratique avant tout.',
...

    {
        ...
        accroche:
            'Sentiers, sandbanks, points de vue, oiseaux. La carte regarde la Loire comme un territoire vivant à fouler.',
...

    {
        ...
        accroche:
            'Châteaux, abbayes, murs anciens. La carte regarde la Loire à hauteur de tuffeau, dans la lumière du soir.',
...

    {
        ...
        accroche:
            'Murs, archives, ponts de pierre, lieux qui ont vu passer les siècles. La carte regarde ce qui reste.',
...

    {
        ...
        accroche:
            'Vignerons, caves, guinguettes, tonnelles. La carte des bouteilles et des tables — le terroir ligérien à hauteur de verre.',
...

    {
        ...
        accroche:
            "Lampions, tonnelles, tables dehors, fenêtres allumées. La Loire qu'on traverse à la fraîche, à la veillée, devant un verre.",
...

    {
        ...
        accroche:
            'Coups de cœur, photos, scènes retenues. Le carnet le plus personnel du projet — un carnet dans le carnet.',
...
export const ALL_PHOTO_CATEGORIES = PHOTO_CATEGORY_GROUPS.flatMap((g) =>
