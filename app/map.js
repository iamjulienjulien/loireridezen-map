...
export const baseOSM = new TileLayer('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', {
    attribution:
...
export const baseOpenTopo = new TileLayer('https://{s}.tile.opentopomap.org/{z}/{x}/{y}.png', {
    subdomains: 'abc',
    maxZoom: 17,
    attribution:
...
export const baseOSMFr = new TileLayer('https://{s}.tile.openstreetmap.fr/osmfr/{z}/{x}/{y}.png', {
    subdomains: 'abc',
    maxZoom: 20,
    attribution:
        "&copy; <a href='https://www.openstreetmap.org/copyright'>OpenStreetMap</a> contributors · rendu <a href='https://tile.openstreetmap.fr'>OSM-FR</a>",
});
...
export function getPositronGL() {
    if (!_positronGL && window.L?.maplibreGL) {
        _positronGL = window.L.maplibreGL({
            ...
            attribution:
                "&copy; <a href='https://www.openstreetmap.org/copyright'>OpenStreetMap</a> contributors · <a href='https://openmaptiles.data.gouv.fr'>openmaptiles.data.gouv.fr</a>",
        });
    }
    return _positronGL;
}
